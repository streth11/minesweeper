...
class MineSolver:
    ...
    def solve(
        self,
        until_state=MineSolverState.COMPLETE,
        print_mode=PrintMode.NoPrint,
        stop_at_stalemate=False,
    ):
    ...
    def frontierRandomGuess(self, frontier_cells: List[MSGridElement]):
        ...
        local_neighbor_prob = [
            np.divide(cell.revealedReducedValue, cell.numUntouchedNeighbors()) for cell in frontier_cells
        ]
...
if __name__ == "__main__":
    ...
    grid = MSGrid(26, 8, nMines=32, seed=seed)
